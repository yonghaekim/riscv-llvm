...
void RISCVFrameLowering::emitPrologue(MachineFunction &MF,
  ...
  //yh+begin
  //BuildMI(MBB, MBBI, DL, TII->get(RISCV::ESTR))
  //  .addReg(RISCV::X1)
  //  .addReg(RISCV::X0)
...
void RISCVFrameLowering::emitEpilogue(MachineFunction &MF,
  ...
  //yh+begin
  //errs() << "MF.getFunction.getName(): " << MF.getFunction().getName() << "\n";
  //errs() << "MF.getFunctionNumber(): " << MF.getFunctionNumber() << "\n";
  //BuildMI(MBB, MBBI, DL, TII->get(RISCV::ECLR))
  //  .addReg(RISCV::X1)
  //  .addReg(RISCV::X0)
  //  .setMIFlag(MachineInstr::FrameSetup);
  //yh+end
